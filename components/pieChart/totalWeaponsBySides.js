...
export default function TotalWeaponsBySides(props) {
    //Initial variable
    ...
    useEffect(() => {
        fetch("https://ww2.leonardhors.site/api/v1/weapons/total/bysides")
        .then(res => res.json())
            .then(
            (result) => {
                setIsLoaded(true);
    ...
    if (error) {
        ...
        return (
            <div className='custom-tbody' style={{padding:"6px"}}>
                <h6>Total {props.source} Weapons By Sides</h6>
